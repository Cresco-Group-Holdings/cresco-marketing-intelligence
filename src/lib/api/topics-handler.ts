...
export const withTopicsRead = (
  ...
  withApiHandler(request, handler, {
    organisationId,
    permission: PERMISSIONS["seoTopics.read"],
  });

export const withTopicsManage = (
  request: NextRequest,
  organisationId: string,
  handler: Parameters<typeof withApiHandler>[1],
) =>
  withApiHandler(request, handler, {
    organisationId,
    permission: PERMISSIONS["seoTopics.manage"],
  });

export const withTopicsCluster = (
  request: NextRequest,
  organisationId: string,
  handler: Parameters<typeof withApiHandler>[1],
) =>
  withApiHandler(request, handler, {
    organisationId,
    permission: PERMISSIONS["seoTopics.cluster"],
  });

export const withTopicsStrategy = (
  request: NextRequest,
  organisationId: string,
  handler: Parameters<typeof withApiHandler>[1],
) =>
  withApiHandler(request, handler, {
    organisationId,
    permission: PERMISSIONS["seoTopics.strategy"],
  });
