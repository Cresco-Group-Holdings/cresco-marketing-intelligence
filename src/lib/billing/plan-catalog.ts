...
export const DEFAULT_PLAN_CATALOG: PlanSeedDefinition[] = [
  {
    ...
    entitlements: [
      ...
      { entitlementKey: ENTITLEMENT_KEYS.PUBLICATIONS_MONTHLY, valueType: "COUNT", limitValue: 25 },
      { entitlementKey: ENTITLEMENT_KEYS.AUTOMATION_EXECUTIONS_MONTHLY, valueType: "COUNT", limitValue: 50 },
  ...
  },
  {
    ...
    entitlements: [
      ...
      { entitlementKey: ENTITLEMENT_KEYS.PUBLICATIONS_MONTHLY, valueType: "COUNT", limitValue: 500 },
      { entitlementKey: ENTITLEMENT_KEYS.AUTOMATION_EXECUTIONS_MONTHLY, valueType: "COUNT", limitValue: 500 },
      { entitlementKey: ENTITLEMENT_KEYS.API_ACCESS, valueType: "BOOLEAN", booleanValue: true },
    ],
    allowances: [
  ...
  },
  {
    ...
    entitlements: [
      ...
      { entitlementKey: ENTITLEMENT_KEYS.PUBLICATIONS_MONTHLY, valueType: "COUNT", limitValue: 2_000 },
      { entitlementKey: ENTITLEMENT_KEYS.AUTOMATION_EXECUTIONS_MONTHLY, valueType: "COUNT", limitValue: 2_000 },
  ...
  },
  {
    ...
    description: "For larger teams, agencies, and multi-brand usage.",
    sortOrder: 4,
    ...
    entitlements: [
      ...
      { entitlementKey: ENTITLEMENT_KEYS.PUBLICATIONS_MONTHLY, valueType: "COUNT", limitValue: 10_000 },
      { entitlementKey: ENTITLEMENT_KEYS.AUTOMATION_EXECUTIONS_MONTHLY, valueType: "COUNT", limitValue: 10_000 },
      { entitlementKey: ENTITLEMENT_KEYS.PERMISSIONS_ADVANCED, valueType: "BOOLEAN", booleanValue: true },
