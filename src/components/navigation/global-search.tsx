...
const SEARCH_ROUTES = [
  ...
  { label: "Organic Social", href: "/organic-social", keywords: "social organic reels growth" },
  { label: "Organic Accounts", href: "/organic-social/accounts", keywords: "social accounts connections" },
