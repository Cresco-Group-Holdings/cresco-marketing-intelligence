  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/content/studio",
        icon: PenSquare,
        description: "Brand-aware content production and channel variants",
      },
      {
        label: "Calendar",
        href: "/calendar",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: LineChart,
        description: "Market and audience insights from Cresco Intelligence",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Database,
        description: "Revenue and performance reporting",
      },
    ],
  },
  {
